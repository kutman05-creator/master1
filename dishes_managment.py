...
#
#
# @dishes_admin_router. callback_query(F.data == "dishes")
# async def  process_name(call: types.CallbackQuery,state: FSMContext) :
#     await call.message.answer ("Введите название блюдо")
...
#
#     # if not price.isdigit():
#     #     await message.answer("Вводите категорию блюдо")
#     #     return
#     # price = int(price)
#     # if price < 0 or price > 2025:
